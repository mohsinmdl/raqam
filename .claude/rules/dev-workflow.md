# Dev workflow — agent notes

Repo conventions for package management, worktrees, and branch hygiene. This
file auto-loads every session (rules without `paths` frontmatter load at launch
with the same priority as `.claude/CLAUDE.md`). For test/validation rules see
