...
export default function LoadingScreen({ message = 'Loading…', error = null, onRetry = null }) {
  ...
  return (
    <div data-theme={devicePrefs.theme} style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg)', color: 'var(--text)', fontFamily: "'IBM Plex Sans', system-ui, sans-serif", fontSize: 14 }}>
